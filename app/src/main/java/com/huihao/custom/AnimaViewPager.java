...
import com.huihao.common.OutlineContainer;
import com.nineoldandroids.view.ViewHelper;

public class AnimaViewPager extends ViewPager {
	...
	public AnimaViewPager(Context context) {
		this(context, null);
	}

	@SuppressWarnings("incomplete-switch")
	public AnimaViewPager(Context context, AttributeSet attrs) {
		super(context, attrs);
