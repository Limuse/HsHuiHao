 ...
 */
public class AddressHorizontalSlidDeleteList extends ListView{
    private AddressHoriSliseAdapter mAdapter;

    public AddressHorizontalSlidDeleteList(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        mAdapter = (AddressHoriSliseAdapter) adapter;
    }
}
